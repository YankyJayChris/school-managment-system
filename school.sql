...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2019 at 12:26 AM
...
(10, 'ADC-II-D-1-2018-2019-IT001', 'ADC', 'II', 'D', 1, '2018-2019', 'chris321', 'IT001', '2019-04-03 03:46:54');
...
(9, 'assn2', 'IT001', 'Assignement', 'ADC-I-D-1-2018-2019-IT001', 'ADC', 'I', 'D', 1, 'chris321', '2018-2019', 50, 1, 1, '2019-03-31 12:11:58'),
(10, 'exam1', 'IT002', 'Exam', 'ADC-I-D-1-2018-2019-IT002', 'ADC', 'I', 'D', 1, 'chris321', '2018-2019', 60, 1, 0, '2019-04-01 09:05:25'),
(11, 'quiz1', 'IT002', 'Quiz', 'ADC-I-D-1-2018-2019-IT002', 'ADC', 'I', 'D', 1, 'chris321', '2018-2019', 10, 1, 1, '2019-04-01 09:46:55'),
(12, 'assn1', 'IT002', 'Assignement', 'ADC-I-D-1-2018-2019-IT002', 'ADC', 'I', 'D', 1, 'chris321', '2018-2019', 100, 1, 1, '2019-04-01 09:49:36'),
(13, 'assn2', 'IT002', 'Assignement', 'ADC-I-D-1-2018-2019-IT002', 'ADC', 'I', 'D', 1, 'chris321', '2018-2019', 30, 1, 1, '2019-04-01 10:25:18'),
(14, 'examyamber', 'IT001', 'Exam', 'ADC-II-D-1-2018-2019-IT001', 'ADC', 'II', 'D', 1, 'chris321', '2018-2019', 80, 1, 1, '2019-04-03 04:19:09');
...
(32, 'ADC', 'Exam', 'ADC-I-D-1-2018-2019-IT002', '2018-2019', 'I', 1, 'exam1', 'chris098', 54, -1, 60, 'chris321', 0, '2019-04-01 09:20:45'),
...
(35, 'ADC', 'Assignement', 'ADC-I-D-1-2018-2019-IT002', '2018-2019', 'I', 1, 'assn1', 'dan1234', 99, -1, 100, 'chris321', 0, '2019-04-01 09:50:00'),
(36, 'ADC', 'Assignement', 'ADC-I-D-1-2018-2019-IT002', '2018-2019', 'I', 1, 'assn1', 'chris098', 98, -1, 100, 'chris321', 0, '2019-04-01 09:50:00'),
...
(39, 'ADC', 'Exam', 'ADC-II-D-1-2018-2019-IT001', '2018-2019', 'II', 1, 'examyamber', '2secstud', 78, -1, 80, 'chris321', 0, '2019-04-03 04:23:05'),
(40, 'ADC', 'Exam', 'ADC-II-D-1-2018-2019-IT001', '2018-2019', 'II', 1, 'examyamber', '2secstud321', 57, -1, 80, 'chris321', 0, '2019-04-03 04:23:05');
...
--
-- Table structure for table `repeatmarks`
--

CREATE TABLE `repeatmarks` (
  `id` int(11) NOT NULL,
  `studentid` varchar(150) NOT NULL,
  `classid` varchar(150) NOT NULL,
  `remarks` int(11) NOT NULL,
  `createdon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `repeatmarks`
--

INSERT INTO `repeatmarks` (`id`, `studentid`, `classid`, `remarks`, `createdon`) VALUES
(1, 'dan1234', 'ADC-I-D-1-2018-2019-IT003', 67, '2019-04-04 22:59:14');
...
(5, '2secstud', 'sec', 'stud', 'ADC', 'D', '2018-2019', 'II', '2019-04-03 04:11:39'),
(6, '2secstud321', 'alan', 'meme', 'ADC', 'D', '2018-2019', 'II', '2019-04-03 04:12:34');
...
INSERT INTO `userdata` (`id`, `username`, `password`, `fname`, `lname`, `level`, `status`, `createdon`) VALUES
(1, 'chris123', '202cb962ac59075b964b07152d234b70', 'chris', 'jay', 'admin', 1, '2019-04-04 20:45:29'),
(2, 'chris321', '202cb962ac59075b964b07152d234b70', 'john', 'christian', 'teacher', 1, '2019-04-04 20:45:29'),
(3, 'karim123', '202cb962ac59075b964b07152d234b70', 'karim', 'khizz', 'student', 1, '2019-04-04 20:45:29'),
(4, 'dan1234', '202cb962ac59075b964b07152d234b70', 'danny', 'he', 'student', 1, '2019-04-04 20:45:29'),
(5, 'chris098', '202cb962ac59075b964b07152d234b70', 'christian', 'jean', 'student', 1, '2019-04-04 20:45:29'),
(6, '2secstud321', '202cb962ac59075b964b07152d234b70', 'alan', 'meme', 'student', 1, '2019-04-04 20:45:29'),
(7, 'hass123', '202cb962ac59075b964b07152d234b70', 'you', 'hassan', 'student', 1, '2019-04-04 20:45:29'),
(8, 'hassan123', '202cb962ac59075b964b07152d234b70', 'assasin', 'hassan', 'teacher', 1, '2019-04-04 20:45:29'),
(9, 'teacher111', '202cb962ac59075b964b07152d234b70', 'teach', 'teacher', 'teacher', 1, '2019-04-04 20:45:29');
...
--
-- Indexes for table `marksseting`
--
ALTER TABLE `marksseting`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`),
  ADD UNIQUE KEY `id_2` (`id`);

--
-- Indexes for table `repeatmarks`
--
ALTER TABLE `repeatmarks`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `marksseting`
--
ALTER TABLE `marksseting`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `repeatmarks`
--
ALTER TABLE `repeatmarks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
